...
// *****************************************************
    ...
    else
    {
        ...
        glUniform4f(wholeObjectDiffuseColour_Location, wholeObjectDebugColour.r,
            wholeObjectDebugColour.g,
            wholeObjectDebugColour.b, 
            wholeObjectDebugColour.a);
    }
   /* glUniform4f(wholeObjectSpecularColour_Location,
    ...
    GLint textureRatios0to3_LocID = glGetUniformLocation(program, "texture2D_Ratios0to3");
    // Set them
