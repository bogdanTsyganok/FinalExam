...
extern cMesh* g_pDebugCylinder;	// = NULL;
...
extern GLint g_matModel_location;
extern GLint g_inverseMatModel_location;

extern gdpPhysics::PhysicsFactory* physicsFactory;
extern gdpPhysics::iPhysicsWorld* physicsWorld;
...
glm::vec3 DirectionToRotation(glm::vec3 direction, glm::vec3 upVec = glm::vec3(0.f, 1.f, 0.f));
///FunctionsEnd
